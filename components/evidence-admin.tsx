...
export function EvidenceAdmin() {
  ...
  return <div className="evidence-console">
    ...
    <section className="evidence-counts" aria-label="Model evidence counts"><div><span>Eligible</span><strong>{data.counts.eligible}</strong></div><div><span>Pending evidence</span><strong>{data.counts.pending}</strong></div><div><span>Manual review</span><strong>{data.counts.manualReview}</strong></div><div><span>Total identities</span><strong>{data.counts.total}</strong></div></section>

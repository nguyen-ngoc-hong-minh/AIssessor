        ...
        <section ref={(el) => { slideRefs.current[5] = el; }} data-index={5} className={`slide ${currentIdx === 5 ? "active" : ""}`} data-section="Pricing plans">
          <div className="slide-inner s-compare">
            ...
            <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch mt-6">
              {/* Card 1: STARTER */}
              <div className="glass-card pricing-deck-card flex flex-col justify-between border border-white/10 w-full relative overflow-visible p-8 pt-8 z-20">
                <div>
                  ...
                  <div className="plan-features-label font-mono text-xs text-indigo-soft uppercase tracking-wider mb-3">Features:</div>
              ...
              {/* Card 2: OPTIMISE (Recommended) */}
              <div className="glass-card pricing-deck-card bg-gradient-to-b from-[#151929] to-[#0c0f1c] border-2 border-indigo-500/60 shadow-2xl relative overflow-visible flex flex-col justify-between p-8 pt-8 z-20 w-full">
                ...
                <div>
                  ...
                  <Link href="/choose-usage" className="btn-primary plan-cta-btn w-full text-center justify-center text-black bg-white hover:bg-indigo-100">
                    Get Started
                  </Link>
                </div>
              </div>
              ...
              {/* Card 3: TEAM */}
              <div className="glass-card pricing-deck-card flex flex-col justify-between border border-white/10 w-full p-8">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                ...
                <div>
                  ...
                  <a href="mailto:sales@aissessor.app" className="btn-secondary plan-cta-btn w-full text-center justify-center">
                    Contact Sales
                  </a>
                </div>
              </div>

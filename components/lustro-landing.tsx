...
const chapters = [
  ...
  { id: "product", label: "BENCHFLOW", sub: "Start with the work" },
...
export function LustroLanding() {
  ...
  return <main className="lustro-deck" ref={deckRef} onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
    ...
    <section id="product" className={`lustro-slide ${active === 2 ? "active" : ""}`} aria-hidden={active !== 2}>
      <div className="lustro-slide-inner lustro-two-column">
        <div className="lustro-chapter-copy">
          <div className="lustro-eyebrow lustro-reveal"><span /> BENCHFLOW</div>
          <h2 className="lustro-display lustro-reveal">Start with the work.<br /><em>Not a leaderboard.</em></h2>
          <p className="lustro-body-lg lustro-reveal">BENCHFLOW understands the task first, then compares only the AI-first products that can help complete it.</p>
    ...
    <section id="modes" className={`lustro-slide ${active === 3 ? "active" : ""}`} aria-hidden={active !== 3}>
      <div className="lustro-slide-inner lustro-feature-slide">
        ...
        <div className="lustro-mode-grid">
          <article className="lustro-mode-card lustro-reveal"><span>01</span><MousePointer2 /><small>One clear outcome</small><h3>One-off Project</h3><p>Create and approve an editable workflow before BENCHFLOW recommends the tools for each step.</p><Link href="/strategy/new/one-off">Plan a project <ArrowRight /></Link></article>

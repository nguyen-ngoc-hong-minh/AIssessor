                ...
                <SignIn
                  ...
                  appearance={{
                    elements: {
                      ...
                      formFieldInput: "rounded-full bg-white/5 border border-white/10 text-white placeholder:text-white/75 text-xs px-4 py-2.5 focus:border-indigo-500 transition-all w-full mb-2.5",

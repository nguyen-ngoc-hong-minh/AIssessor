            ...
            {!authConfigured ? (
              ...
              <div className="clerk-container">
                <SignIn
                  ...
                  appearance={{
                    elements: {
                      rootBox: "w-full max-w-[380px] mx-auto px-4",
                      ...
                      headerSubtitle: "text-ink-2 text-xs text-center mb-6",
                      socialButtonsBlockButton: "rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 text-xs py-3 px-4 font-medium transition-all w-full mb-4",
                      socialButtonsBlockButtonText: "text-white text-xs font-medium",
                      dividerLine: "bg-white/10",
                      dividerText: "text-ink-3 text-[10px] font-mono uppercase px-2",
                      formFieldLabel: "text-white text-xs font-medium mb-2 block",
                      formFieldInput: "rounded-xl bg-white/5 border border-white/10 text-white text-xs px-4 py-3 focus:border-indigo-500 transition-all w-full mb-4",
                      formButtonPrimary: "rounded-xl bg-white hover:bg-indigo-100 text-black text-xs font-semibold py-3.5 transition-all w-full mt-4 mb-4 shadow-lg",
                      footer: "bg-transparent border-t border-white/10 pt-4 mt-6 text-xs text-ink-3 text-center",

                ...
                <SignIn
                  ...
                  appearance={{
                    elements: {
                      ...
                      socialButtonsBlockButtonBadge: "relative top-0 left-0 transform-none inline-block mx-auto mb-1 px-3 py-0.5 text-[11px] font-medium text-ink-2 bg-slate-100 dark:bg-slate-800 border border-indigo-400/30 rounded-full shadow-sm",

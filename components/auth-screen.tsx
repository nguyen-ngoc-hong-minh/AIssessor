                ...
                <SignIn
                  ...
                  appearance={{
                    elements: {
                      ...
                      socialButtonsBlockButton: "rounded-full bg-input-bg border border-input-border text-ink hover:opacity-90 text-xs py-2.5 px-4 font-medium transition-all w-full mb-2.5 styled-input",

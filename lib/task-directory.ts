...
export const taskCategories = [
  {
    ...
    label: "Creativity",
    description: "Make images, video, audio, presentations, and visual concepts.",
    subcategories: ["Images", "Design", "Video", "Audio", "Presentations"],
  },
  {
    id: "work" as const,
    label: "Work",
    description: "Research, build software, and move professional work forward.",
    subcategories: ["Research", "Coding", "App building"],
  },
  {
    id: "personal" as const,
    label: "Personal",
    description: "Learn, study, and plan everyday experiences with AI support.",
    subcategories: ["Learning", "Education", "Travel"],
  },
];

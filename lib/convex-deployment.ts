export const ACTIVE_CONVEX_URL = "https://gregarious-ox-542.convex.cloud";
export const ACTIVE_CONVEX_SITE_URL = "https://gregarious-ox-542.convex.site";

const RETIRED_CONVEX_URLS = new Set([
  "https://scrupulous-deer-129.convex.cloud",
  "https://perceptive-snake-642.convex.cloud",
  "https://terrific-hamster-925.convex.cloud",
]);

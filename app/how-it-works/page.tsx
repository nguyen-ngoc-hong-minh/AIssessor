...
export const metadata: Metadata = { title: "How It Works · BENCHFLOW" };

const steps = [
  ["01.", "Describe Objectives", "Tell BENCHFLOW what you need in everyday language, along with budget, timing, and priorities."],
      ...
      <main className="section how-it-works-page">
        <div className="how-header-block">
          ...
          <p className="lead-text">
            BENCHFLOW separates understanding your workload from choosing the technology. This guarantees unbiased, verifiable recommendations tailored to your exact budget and requirements.
          </p>
        </div>

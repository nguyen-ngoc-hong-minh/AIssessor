...
export default function LandingPage() {
  return <><SiteHeader /><main>
    <section className="hero section"><div className="hero-copy"><span className="kicker"><Sparkles /> Plain-language AI planning</span><h1>Find the right AI setup for the work you actually do.</h1><p>Describe a project or your recurring monthly work. BENCHFLOW creates the workflow, compares compatible AI options, and recommends a cost-effective AI strategy.</p><div className="hero-actions"><Button asChild size="lg"><Link href="/sign-up">Build My AI Strategy <ArrowRight /></Link></Button><Button asChild variant="outline" size="lg"><Link href="/how-it-works">See How It Works</Link></Button></div><div className="trust-line"><span><Check /> No AI knowledge needed</span><span><Check /> Explainable comparisons</span><span><Check /> Source-dated data</span></div></div><div className="hero-product" aria-label="BENCHFLOW product workflow preview"><div className="product-top"><span /><span /><span /><b>Campaign workflow</b><em>Ready to review</em></div><div className="goal-card"><small>Your goal</small><strong>Launch a neighbourhood café</strong><p>Campaign assets for opening week</p></div><div className="mini-flow"><div><span><Search /></span><b>Research</b><small>Market and audience</small></div><i>→</i><div><span><MousePointer2 /></span><b>Write copy</b><small>Messages and offers</small></div><i>→</i><div><span><Sparkles /></span><b>Create visuals</b><small>Five launch assets</small></div></div><div className="fit-card"><span><ShieldCheck /></span><div><small>Recommendation status</small><strong>Compatible options found</strong></div><b>Evidence checked</b></div></div></section>
